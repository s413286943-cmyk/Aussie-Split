...
- [ ] **Step 3: Render and inspect the protected-base workbook**
...
- [ ] **Step 4: Add the four fixed stops without replacing QVM**
...
- [ ] **Step 5: Export, regenerate, and verify GREEN**
...
- [ ] **Step 7: Commit the content merge**
...
- [ ] **Step 1: Add failing split-stylesheet contract tests**
...
- [ ] **Step 3: Apply the minimum CSS port**
...
- [ ] **Step 1: Run route, API, offline, receipt, PWA, and security tests**
...
- [ ] **Step 3: Commit plan/spec documentation only if needed**
...
- [ ] **Step 1: Start the production build with Node 24**
...
- [ ] **Step 3: Verify `390x844` mobile behavior**
...
- [ ] **Step 4: Verify offline reload locally**
...
- [ ] **Step 1: Deploy one preview from the clean recovery branch**

- [ ] **Step 2: Verify real protected access and read-only ledger totals**
...
- [ ] **Step 3: Run isolated reversible mutation checks**

Use uniquely named QA data to test add, edit, split-settle, delete/Undo, final cleanup, and one small private receipt upload/download. Remove all QA rows and objects, then recheck baseline totals.

- [ ] **Step 4: Run preview desktop/mobile/offline checks**
...
- [ ] **Step 1: Promote the exact verified preview build**

- [ ] **Step 2: Verify production read-only state and UI**
